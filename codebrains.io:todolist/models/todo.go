...
func GetTodoById(c *fiber.Ctx) error {
	...
	if err != nil {
		return c.Status(404).JSON(fiber.Map{
			"status": "error", "message": "Could not find todo", "data": err,
		})
	}
	return c.JSON(&todo)
}
...
func CreateTodo(c *fiber.Ctx) error {
	...
	if err != nil {
		return c.Status(500).JSON(fiber.Map{
			"status": "error", "message": "Check your input", "data": err,
		})
	}
	err = db.Create(&todo).Error
	if err != nil {
		return c.Status(500).JSON(fiber.Map{
			"status": "error", "message": "Could not create todo", "data": err,
		})
	}
	return c.JSON(&todo)
}
...
func UpdateTodo(c *fiber.Ctx) error {
	...
	if err != nil {
		return c.Status(500).JSON(fiber.Map{
			"status": "error", "message": "Review your input", "data": err,
		})
	}
